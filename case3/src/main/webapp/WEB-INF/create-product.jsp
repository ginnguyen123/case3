                ...
                <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                  ...
                  <li class="navbar-vertical-aside-has-menu ">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="#" title="Add Product">
              ...
              <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                ...
                <li class="navbar-vertical-aside-has-menu ">
                  ...
                  <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                    ...
                    <li class="nav-item">
                      <a class="nav-link " href="#" title="Add Product">
                        <span class="tio-circle-outlined nav-indicator-icon"></span>
                        <span class="text-truncate">Add Product</span>
                      </a>
                    </li>
            ...
            <c:if test="${requestScope.message != null}">
              ...
              <div class="toast" data-autohide="true" style="position: fixed; top: 0; right: 0">
                <div class="toast-header">
                  <strong class="mr-auto text-primary">Đã cập nhật thành công</strong>
                ...
                <div class="card-body">
                  ...
                  <div id="attachFilesNewProjectLabel" class="form-group js-dropzone dropzone-custom custom-file-boxed dz-clickable">
                    <div class="dz-message custom-file-boxed-label">
                      <div>
                        <img src="/images/${requestScope.product.getImage()}" id="idImage"  style="width: 200px; height: auto"/>
                      </div>
                    ...
                    <div class="card-body">
                      <div class="row justify-content-center justify-right">
                        ...
                        <div class="form-group col-auto">
                          ...
                          <button type="button" class="btn btn-ghost-light mr-2"><a href="/product">Back</a></button>
